	...
	return (
		<div>
			...
			<div id="contact" className="relative">
				<div className="flex items-center flex-col bg-primary-500 h-[200vh] pt-[100px]">
					<div className="flex items-center flex-col mb-[70px]">
						<p className="flex justify-center items-center text-[60px] font-bold mb-[-6px] bg-white w-[310px] h-[90px] text-black rounded-full drop-shadow-xl pb-1 tracking-wider">Contact</p>
					</div>
					<div
						className="relative w-[790px] h-[850px] bg-sky-200 rounded-[15px] overflow-hidden            
